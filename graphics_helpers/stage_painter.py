...
def paint_center(batch, x_c, y_c):
	...
	centers_store = transform_store(centers_store, x_c, y_c)
	for _, point in centers_store.points.items():
		batch.add(1, GL_POINTS, None, ("v2i", (point.x, point.y)), ("c3B", map_to_point_colour(CENTER_COLOUR)))
